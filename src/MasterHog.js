    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog attributes={offspring[0]} eyeColor={this.state.eyeColor}/>
          <BabyHog attributes={offspring[1]} eyeColor={this.state.eyeColor}/>
          <BabyHog attributes={offspring[2]} eyeColor={this.state.eyeColor}/>
        </ul>
